...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const GOOGLE_SHEET_URL = 'https://script.google.com/macros/s/AKfycbw5Fttb6OxFqUbzf6fdD9KSygQFFMTF-NLa3EEn7bbDd-uOArCcvJRaiMaqRMzN6gvq/exec';
      ...
      <section id="contact" className="py-32 px-4 sm:px-6 lg:px-8 bg-gray-950 flex items-center justify-center min-h-[600px]">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-lg max-w-md mx-auto">
            Thank you for reaching out. Our team will get back to you within 24 hours to discuss your project.
          </p>
          <button
            onClick={() => setStatus('')}
