...
app.get('/api/og/product/:slug', async (req, res) => {
  try {
    ...
    const imageUrl = product.imageUrl || 'https://growyourbusiness.today/logo.png'; // Fallback logo
    ...
    const html = `
      ...
      <body>
        <p>Redirecting...</p>
        <script>
          // If a real user somehow lands here, redirect them to the frontend app
